var app = (function () {
  ...
  function v() {
    if (!_) {
      ...
      do {
        ...
        for (d(null), p.length = 0; h.length; ) h.pop()();
  ...
  function j(t, e) {
    -1 === t.$$.dirty[0] &&
      (p.push(t), b || ((b = !0), g.then(v)), t.$$.dirty.fill(0)),
      (t.$$.dirty[(e / 31) | 0] |= 1 << e % 31);
  }
  function E(c, u, i, s, l, p, h = [-1]) {
    const $ = f;
    d(c);
    const m = u.props || {},
      g = (c.$$ = {
    ...
    if (
      ((g.ctx = i
        ? i(c, m, (t, e, ...n) => {
            ...
            return (
              g.ctx &&
                l(g.ctx[t], (g.ctx[t] = o)) &&
                (!g.skip_bound && g.bound[t] && g.bound[t](o), b && j(c, t)),
              e
            );
          })
        : []),
      ...
      u.intro && (_ = c.$$.fragment) && _.i && (w.delete(_), _.i(x)),
        (function (t, n, c) {
          const {
            fragment: u,
            on_mount: a,
    ...
    return {
      c() {
        (n = i("main")),
          ...
          l(o, "class", "svelte-1tky8bj"),
          l(n, "class", "svelte-1tky8bj");
      },
      m(t, e) {
        !(function (t, e, n) {
